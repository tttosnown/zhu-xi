const CACHE='zhuxi-v33-startup-weekfix';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./code-bank.json','./code-bank.min.json','./norm-library.json'];
