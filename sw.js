const CACHE='zhuxi-v26-2.2-random-exclude-english-politics';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./code-bank.json','./code-bank.min.json'];
